    ...
    <form onSubmit={handleOTPSubmit} className="space-y-4">
      <div className="space-y-2">
        ...
        <Input
          ...
          maxLength={6}
                      className="text-center text-lg font-mono tracking-widest text-gray-900 placeholder-gray-400 bg-white border-gray-300"
          required
        />
      ...
      <div className="flex gap-2">
        ...
        <Button type="submit" className="flex-1" disabled={loading}>
                      <span className="text-gray-100">{loading ? "Verifying..." : "Verify OTP"}</span>
        </Button>
      </div>
        ...
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-gray-900">
            ...
            {getStepTitle()}
                      ...
                      <DialogDescription className="text-gray-700">{getStepDescription()}</DialogDescription>
        </DialogHeader>
