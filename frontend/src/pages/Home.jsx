        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
              Building enterprise-grade AI, ML, and Generative AI and cloud solutions for tomorrow's digital leaders.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
              We pioneer responsible and future-ready AI innovations including explainable AI and AI-powered business automation.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300">
              Comprehensive AI, ML, and technology solutions for modern enterprises
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {solutions.map((solution, index) => (
              ...
              >
                <CardHeader>
                  <CardTitle className="text-lg text-blue-700 dark:text-blue-300 font-semibold">
                    {solution.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300">
              Delivering AI solutions across diverse industry sectors
            </p>
          </div>
          <div className="flex flex-wrap justify-center gap-4">
            {industries.map((industry, index) => (
              <Badge
                key={index}
                variant="secondary"
                className="px-4 py-2 text-sm text-green-700 dark:text-green-300 bg-green-100 dark:bg-[#23272f] border border-green-200 dark:border-gray-700"
              >
                {industry}
              </Badge>
            ))}
      ...
      <section className="py-16 bg-gray-50 dark:bg-[#23272f]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
              Scalable AI solutions designed for enterprise needs and budgets.
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300">
              Advanced training programs for IT professionals and future career development
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center mt-8">
            <Button
              ...
              className="bg-white dark:bg-[#23272f] text-blue-700 border-blue-700 hover:bg-blue-50 dark:hover:bg-[#23272f] font-bold"
            >
              <Link to="/trainings">View All Training Programs</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section id="faq" className="py-16 bg-gray-50 dark:bg-[#23272f]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300">
              Get answers to common questions about our AI and enterprise solutions
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-100 to-blue-300 text-gray-900 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 dark:text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 mb-8">
            Join leading enterprises that have transformed their operations with SOLNEX's AI solutions.
          </p>
